...
SELECT 
    ...
    COALESCE(COUNT(o.orderNumber), 0) AS orderCount,
...
-- SOAL TAMBAHAN
START TRANSACTION 
INSERT INTO klub(id, nama_klub, kota_asal) VALUES(1, 'klub 1', 'makassar');

INSERT INTO pemain(id, nama_pemain, posisi, id_klub) VALUES(1, 'budi', 'pemain tengah', 1);

UPDATE pemain SET nama_pemain = 'anor' WHERE id = 1;
